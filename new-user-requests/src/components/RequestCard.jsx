...
const RequestCard = ({businessArea, firstName, lastName, lineManager, startDate}) => {
  return (
    <div className='max-w-sm p-6 bg-white border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 text-left'>
        ...
        <div className='flex justify-start items-center gap-3 mt-8'>
            <a href="#" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-slate-800 hover:text-white bg-slate-100 rounded-lg hover:bg-emerald-600 transition-all focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Complete
            ...
            <a href="#" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white hover:text-white bg-red-500 rounded-lg hover:bg-red-700 transition-all focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Delete
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 ml-2 -mr-1">
